...
export const SIGNUP = gql`
   mutation signup($name: String!, $phone: String!, $gender: String!, $email: String!) {
      createUser(data: { name: $name, phone: $phone, gender: $gender, email: $email }) {
         id
      }
   }
`
   ...
   return (
      <Center>
         ...
         >
            ...
            <FormControl label="שם" defaultValue="" isInvalid={Boolean(errors.name)}>
