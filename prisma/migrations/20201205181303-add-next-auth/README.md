# Migration `20201205181303-add-next-auth`

This migration has been generated by yuval Styr at 12/5/2020, 8:13:03 PM.
...
ALTER TABLE "public"."_UserToWorkout" ADD FOREIGN KEY("A")REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE
```
...
migration 20201101170627-remove-time-field..20201205181303-add-next-auth
--- datamodel.dml
+++ datamodel.dml
@@ -3,21 +3,11 @@
 }
